				...
				>
					<div className="chbe-modal__row">
						<div className="chbe-modal__col">
							...
							<img
								src={ chbeObj.assetPath + '/assets/images/admin/editor-config/editor-options/suggest-font-size_1.jpg' }
						...
						<div className="chbe-modal__col">
							...
							<img
								src={ chbeObj.assetPath + '/assets/images/admin/editor-config/editor-options/suggest-font-size_2.jpg' }
