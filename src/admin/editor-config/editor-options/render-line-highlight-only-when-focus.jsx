...
const RenderLineHighlightOnlyWhenFocus = () => {
	...
	return (
		<PanelRow>
			...
			{ isModalOpen && (
				<Modal
					title={ __( 'Highlight current line only the editor is focused', 'custom-html-block-extension' ) }
				...
				>
					<div className="chbe-modal__row">
						<div className="chbe-modal__col">
							...
							>
								<img
									src={ chbeObj.assetPath + '/assets/images/admin/editor-config/editor-options/render-line-highlight-only-when-focus_1.gif' }
						...
						<div className="chbe-modal__col">
							...
							>
								<img
									src={ chbeObj.assetPath + '/assets/images/admin/editor-config/editor-options/render-line-highlight-only-when-focus_2.gif' }
