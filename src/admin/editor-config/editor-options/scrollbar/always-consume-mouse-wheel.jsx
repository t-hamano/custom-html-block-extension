				...
				>
					<div className="chbe-modal__row">
						<div className="chbe-modal__col">
							...
							>
								<img
									src={ chbeObj.assetPath + '/assets/images/admin/editor-config/editor-options/scrollbar/always-consume-mouse-wheel_1.gif' }
									alt={ __( 'Enable (default)', 'custom-html-block-extension' ) }
								/>
							</Button>
							<p>{ __( 'Browser does not scroll when mouse wheel reaches the beginning or end.', 'custom-html-block-extension' ) }</p>
						</div>
						<div className="chbe-modal__col">
							...
							>
								<img
									src={ chbeObj.assetPath + '/assets/images/admin/editor-config/editor-options/scrollbar/always-consume-mouse-wheel_2.gif' }
									alt={ __( 'Disable', 'custom-html-block-extension' ) }
								/>
							</Button>
							<p>{ __( 'Browser will scroll when mouse wheel reaches the beginning or end.', 'custom-html-block-extension' ) }</p>
						</div>
					</div>
				</Modal>
			)}
