						...
						<div className="chbe-modal__col">
							...
							>
								<img
									src={
										chbeObj.pluginUrl +
										'/assets/images/admin/editor-config/editor-options/scrollbar/vertical-has-arrows_1.jpg'
									}
						...
						<div className="chbe-modal__col">
							...
							>
								<img
									src={
										chbeObj.pluginUrl +
										'/assets/images/admin/editor-config/editor-options/scrollbar/vertical-has-arrows_2.jpg'
									}
