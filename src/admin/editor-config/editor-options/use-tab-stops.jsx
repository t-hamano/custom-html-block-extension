...
const UseTabStops = () => {
	...
	return (
		<PanelRow>
			...
			{ isModalOpen && (
				<Modal
					title={ __( 'Insert or delete whitespace according to tab position', 'custom-html-block-extension' ) }
				...
				>
					<div className="chbe-modal__row">
						<div className="chbe-modal__col">
							...
							>
								<img
									src={ chbeObj.assetPath + '/assets/images/admin/editor-config/editor-options/use-tab-stops_1.gif' }
						...
						<div className="chbe-modal__col">
							...
							>
								<img
									src={ chbeObj.assetPath + '/assets/images/admin/editor-config/editor-options/use-tab-stops_2.gif' }
