...
import { PanelBody, PanelRow, Button, FormFileUpload } from '@wordpress/components';
			...
			<PanelRow>
				<div>
					...
					<div className="chbe-file-upload">
						...
						/>
						{ importFile && <p className="chbe-file-upload__name">{ importFile.name }</p> }
					</div>
					<Button isPrimary disabled={ ! importFile } onClick={ handleImportOptions }>
